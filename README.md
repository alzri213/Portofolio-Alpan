  <h1>fikrialifa.site</h1>
  <p>🔥 Personal website was built originally from scratch using Next.js, TypeScript, Tailwind CSS, SWR, and Prisma</p>

[![GitHub Repo stars](https://img.shields.io/github/stars/fikrialifa/satria.com)](https://github.com/fikrialifa/satria.com/stargazers)
[![Depfu](https://badges.depfu.com/badges/02483ebb21fdb2182a66a28b68d1b7b0/status.svg)](https://depfu.com)
[![Depfu](https://badges.depfu.com/badges/02483ebb21fdb2182a66a28b68d1b7b0/overview.svg)](https://depfu.com/github/fikrialifa/satria.com?project_id=38809)
[![Depfu](https://badges.depfu.com/badges/02483ebb21fdb2182a66a28b68d1b7b0/count.svg)](https://depfu.com/github/fikrialifa/satria.com?project_id=38809)
...
1. Clone using git
   ...
   ```bash
   git clone https://github.com/fikrialifa/fikrialifa.site
   ```

2. Using `create-next-app`

   ```bash
   npx create-next-app -e https://github.com/fikrialifa/fikrialifa.site project-name
   ```

3. Using `degit`

   ```bash
   npx degit fikrialifa/fikrialifa.site YOUR_APP_NAME
   ```
