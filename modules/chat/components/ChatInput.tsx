      ...
      <form className="flex flex-col gap-2 px-4 border-t border-neutral-300 py-4 dark:border-neutral-700">
        {replyName && (
          <motion.div
            ...
            className="flex items-center justify-between gap-2 rounded-lg border-l-4 border-emerald-500 bg-neutral-100 p-2 dark:bg-neutral-800"
          >
            <div className="flex flex-col gap-0.5 overflow-hidden">
              <span className="text-[11px] font-bold text-emerald-600 dark:text-emerald-500">
                Replying to {replyName}
              </span>
              <span className="truncate text-xs text-neutral-500 dark:text-neutral-400 opacity-80 line-clamp-1 italic">
                {replyMessage}
              </span>
            </div>
            <CloseIcon
              ...
              className="cursor-pointer text-neutral-400 transition-colors hover:text-red-500 shrink-0"
            />
          </motion.div>
        )}
        <div className="flex">
